...
def demo_lines(result: dict, evidence_path: str, sample: bool = True) -> list[str]:
    ...
    lines = [
        ...
        f"  [bright_green]OK[/bright_green] Notion applications loaded: [bright_cyan]{insights.get('total_applications', 0)}[/bright_cyan]",
        ...
        f"  [bright_green]OK[/bright_green] Joined notion.applications + github.activity + linkedin.skills",
