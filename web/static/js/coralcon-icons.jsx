// CoralCon Icons — Minimal SVG icon components (Lucide-style)
...
function CCIcon({ name, size = 20, className = '', style = {} }) {
  const paths = ccIconPaths[name];
...
Object.assign(window, { CCIcon, ccIconPaths });
